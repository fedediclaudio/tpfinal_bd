...
public class SupplierProductController {
    ...
    public ProductDTO createProduct(@PathVariable(value = "id") ObjectId supplierId, @RequestBody Product product){		
	...
	public Product readProduct(@PathVariable(value = "id") ObjectId supplierId, @PathVariable(value = "name") String nameProducto){
		return this.supplierService.readProduct(supplierId, nameProducto);				
	}
	...
	public Product updateProduct(@RequestBody Product productDetails, @PathVariable(value = "id") ObjectId supplierId,@PathVariable(value = "name") String nameProducto){
	...
	public void deleteProduct(@PathVariable(value = "id") ObjectId supplierId, @PathVariable(value = "name") String nameProducto){
	 ...
	 * @return
	 */
	@GetMapping("suppliers/{id}/product/{name}/pricebetweendates") //falta
	public Collection<DateDTO> getPricesBetweenDates(@RequestParam (name = "dateFrom") @DateTimeFormat (iso = DateTimeFormat.ISO.DATE) LocalDate dateFrom, 
			@RequestParam (name = "dateTo") @DateTimeFormat (iso = DateTimeFormat.ISO.DATE) LocalDate dateTo,
			@PathVariable(value = "id") ObjectId supplierId, @PathVariable(value = "name") String nameProducto ) {
	...
	public ProductType readProductType(@PathVariable(value = "id") ObjectId productTypeId){
	...
	public Supplier readSupplier(@PathVariable(value = "id") ObjectId supplierId){
	...
	@PostMapping ("/suppliers/{id}/supplierType/{idST}")
	 public Supplier addSupplierType(@PathVariable(value = "id") ObjectId supplierId, @PathVariable(value = "idST") ObjectId supplierTypeId){		
	...
	public SupplierType readSupplierType(@PathVariable(value = "id") ObjectId supplierTypeId){
	...
	public OrderItemsDTO getOrderMasProductsForSupplier(@PathVariable(value = "id") ObjectId supplierId)throws Exception{
	...
	public Collection<SupplierDTO> getAllSuppliersForSupplierType(@PathVariable(value = "id") ObjectId supplierTypeId){
	...
	public Collection<ProductDTO> getAllProductsAndTypeForSupplier(@PathVariable(value = "id") ObjectId supplierId){
		return this.supplierService.getAllProductsAndTypesForSupplier(supplierId);
	}
	
	/**Recupero los diez proveedores que más órdenes despacharon/enviaron // falta arreglar
	 * @return una Collección
	 */
